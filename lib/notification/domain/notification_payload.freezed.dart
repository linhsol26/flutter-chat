...
class _$_NotificationPayload extends _NotificationPayload {
  const _$_NotificationPayload({required this.body, required this.title})
      : super._();
  ...
  @override
  String toString() {
    return 'NotificationPayload(body: $body, title: $title)';
  }
...
abstract class _NotificationPayload extends NotificationPayload {
  const factory _NotificationPayload(
      ...
      required final String title}) = _$_NotificationPayload;
